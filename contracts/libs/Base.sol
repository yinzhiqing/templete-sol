...
ERC721PausableUpgradeable, IBase {
     ...
     */
    function __Base_init(string memory name_, string memory symbol_, string memory baseTokenURI) internal initializer {
        ...
        __Base_init_unchained(baseTokenURI);
    }

    function __Base_init_unchained(string memory baseTokenURI) internal initializer {
    ...
    function _mint(address to, uint256 tokenId, bytes32 name_, string memory datas) internal virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), 
                "Base: must have minter role to mint");
        ...
        emit UpdateDatas(_msgSender(), _msgSender(), tokenId, name_, datas);
    }
    ...
    */
    ...
    function pause() public virtual override {
        require(hasRole(PAUSER_ROLE, _msgSender()), 
                "Base: must have pauser role to pause");
    ...
    function unpause() public virtual override {
        require(hasRole(PAUSER_ROLE, _msgSender()), 
                "Base: must have pauser role to unpause");
    ...
    */
    ...
    function _update(uint256 tokenId, string memory datas) internal virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "Base: must have minter role to mint");
        require(_exists(tokenId), "Base: operator query for nonexistent token.");
    ...
    function exists(uint256 tokenId) public view virtual override(IBase) returns(bool) {
