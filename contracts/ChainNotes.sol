    ...
    PausableUpgradeable
{
    ...
    public 
    {
        __ChainNotes_init(name_, symbol_);

    }
    function __ChainNotes_init(string memory name_, string memory symbol_)
    internal 
    initializer 
    {
        __Pausable_init_unchained();
        __AccessControlEnumerable_init_unchained();
        __ChainNotes_init_unchained(name_, symbol_);
    }

    function __ChainNotes_init_unchained(string memory name_, string memory symbol_) 
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ChainNotes: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ChainNotes: must have pauser role to unpause");
        _unpause();
    }

    function write(string memory data) public whenNotPaused virtual {
        //require(hasRole(WRITER_ROLE, _msgSender()), "ChainDNS: must have pauser role to set");
